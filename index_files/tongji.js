...
{
	var unit_id     = "1412488";
	var client_ip   = "119.167.235.169";
	var server_time = "1366267058";
	var verify_code = "c6023785";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1412488/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
